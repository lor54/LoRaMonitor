  ...
  <div class="container">
    ...
    <div class="btn-group">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item <?php if($choosenLanguage == "it") echo 'disabled'; ?>" onclick="changeLanguage('it')">Italiano <span class="fi fi-it fis"></span></a></li>
        <li><a class="dropdown-item <?php if($choosenLanguage == "en") echo 'disabled'; ?>" onclick="changeLanguage('en')">English <span class="fi fi-gb fis"></span></a></li>
      </ul>
    </div>
    </div>
  </div>
